  ...
  return (
    ...
    <AnimatePresence>
      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:absolute w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          {/* <motion.svg
      ...
      />
          ...
          >
            Renting made<br />
            <span className="text-[#407BBF]">quick <b className="text-[#1E2B3A]">&</b> simple.</span>
          ...
          >
            <div className="w-1/2">
              ...
              Your Boston Housing Journey Starts Here. Simple Solutions for Renters
              </p>
            </div>
            <div className="w-1/2">
              <h2 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              ...
              >
                <span className="mr-2">  Find Roommates </span>
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
                  fill="none"
        ...
        <motion.canvas
          ...
          id="gradient-canvas"
          data-transition-in
          className="z-50 absolute top-0 right-[-2px] w-[80%] md:w-1/2 h-screen bg-[#c3e4ff]"
        ></motion.canvas>
